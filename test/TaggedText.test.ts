...
<nan>hello</nan>`;
  ...
  describe("destructor", () => {
    it("Should destroy the references to children of this object. ", () => {
      ...
      expect(tt.textContainer.children).toHaveLength(0);
      expect(tt.spriteContainer.children).toHaveLength(0);
      expect(tt.debugContainer.children).toHaveLength(0);
      expect(tt.decorationContainer.children).toHaveLength(0);
